                ...
                <div className="grid grid-cols-4 gr grid-rows-3 gap-2 p-2 transition-all w-full ">
                    {
                        aiTools.map((item, index) => (
                            item.visibility && <a
                                ...
                                key={index}
                                target="_blank"
                                className="flex flex-col items-center h-15 justify-start gap-2 p-2 rounded-lg  hover:bg-[var(--color-primary)] hover:text-white transition-all duration-300 "
                            >
                                {
                    ...
                    <div onClick={() => setIsOpen(true)} className="group flex flex-col justify-center items-center overflow-hidden  gap-2 rounded-lg hover:bg-[var(--color-primary)] transition-all hover:text-white duration-300">
                        <svg
                        ...
                        <p className="text-xs text-center  w-full">Edit</p>
                    </div>
                </div>
            </div>
